...
public final class attendance extends javax.swing.JFrame {
    ...
    public void subject()
    {
        ...
        if (cbsem.getSelectedIndex()==2)
        {
            String b = lbl_branch.getText();
            if (b=="Computer")
            {
                s1.setText("EM-3");
                s2.setText("DSGT");
        ...
        if (cbsem.getSelectedIndex()==5)
        {
            String c=lbl_branch.getText();
            if (c=="Computer")
            {
                s1.setText("SP&CC");
                s2.setText("C&SS");
        ...
        if (cbsem.getSelectedIndex()==7)
        {
            String d= lbl_branch.getText();
            if (d== "Computer")
            {
                s1.setText("HMI");
                s2.setText("DC");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sem :");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 60, 70, 50));

        lbl_branch.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lbl_branch.setText("Computer");
        jPanel1.add(lbl_branch, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 60, 130, 40));

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel3.setText("Name :");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 60, 70, 40));

        cbsem.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        cbsem.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sem 1", "Sem 2", "Sem 3", "Sem 3", "Sem 4", "Sem 5", "Sem 6", "Sem 7", "Sem 8" }));
        cbsem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbsemActionPerformed(evt);
            }
        });
        jPanel1.add(cbsem, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 70, 90, 30));

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setText("Branch :");
        jLabel4.setToolTipText("");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 60, 70, 40));

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel5.setText("PNR :");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 60, 60, 40));

        lbl_pnr.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lbl_pnr.setText(".");
        jPanel1.add(lbl_pnr, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 60, 120, 40));

        lbl_name.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lbl_name.setText(".");
        jPanel1.add(lbl_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 60, 210, 40));
        ...
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 430, 150, 40));
        ...
        jPanel2.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 0, 210, 50));
        ...
        jPanel2.add(att, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 430, 130, 40));
        ...
        jPanel2.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 430, 120, 40));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, 830, 480));

        jButton2.setBackground(new java.awt.Color(0, 102, 102));
        jButton2.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jButton2.setText("Save");
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 610, 150, 40));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 980, 770));

        setBounds(440, 0, 995, 805);
    ...
    public static javax.swing.JComboBox<String> cbsem;
